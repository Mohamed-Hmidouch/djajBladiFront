...
import { getStock, createStockItem } from '@/lib/admin';
import { ApiError } from '@/lib/api';
import { StockType } from '@/types/admin';
import type { StockItemResponse, CreateStockRequest } from '@/types/admin';
import {
  AdminPageShell,
  AdminPanel,
  AdminBentoGrid,
...
export default function AdminStockPage() {
  ...
  return (
    <AdminPageShell
      ...
      subtitle="Gerez votre inventaire d'aliments, vaccins et vitamines. Surveillez les niveaux de stock."
      accent="stock"
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
          {([
            { type: 'Feed' as StockType, count: feedCount, unit: 'unites' },
