            ...
            {fcrSummaries.map((fcr) => {
              ...
              return (
                ...
                >
                  ...
                  {fcr.fcrAlert && fcr.cumulativeFcr != null && (
                    <div className="mt-3 flex items-start gap-2 px-3 py-2.5 rounded-xl bg-[var(--color-brand)]/8 border border-[var(--color-brand)]/20">
                      <svg className="w-3.5 h-3.5 text-[var(--color-brand)] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                      </svg>
                      <p className="text-xs text-[var(--color-brand)] font-medium leading-snug">
                        ICR {fcr.cumulativeFcr.toFixed(2)} depasse le seuil de {fcr.fcrThreshold} — consommation alimentaire trop elevee par rapport au gain de poids estime. Verifiez les distributions et pesees.
                      </p>
                    </div>
                  )}
                </div>
